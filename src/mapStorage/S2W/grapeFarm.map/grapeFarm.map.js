        ...
        },
        {
          ...
          elementDrawInfo: {
            ...
            patternInfo: {
              patternSize: [10, 10],
              patternList: [
                { patternType: 'image', fill: '/out/cell', size: [10, 10], opacity: 0.5 },
              ],
            },
            strokeInfo: { color: '#ccc', linecap: 'rect', width: 0.5 },
          },
        ...
        },
        {
          ...
          elementDrawInfo: {
            ...
            patternInfo: {
              patternSize: [10, 10],
              patternList: [
                { patternType: 'image', fill: '/out/cell', size: [10, 10], opacity: 0.8 },
              ],
            },
            strokeInfo: { color: '#ccc', linecap: 'rect', width: 0.5 },
          },
      ...
      svgPlaceList: [
        {
          id: 'VNH_1',
          name: '하우스_1',
          point: [100, 30, 550, 110],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_2',
          name: '하우스_2',
          point: [100, 130, 550, 210],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_3',
          name: '하우스_3',
          point: [100, 230, 550, 310],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_4',
          name: '하우스_4',
          point: [100, 330, 550, 410],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_5',
          name: '하우스_5',
          point: [100, 430, 550, 510],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_6',
          name: '하우스_6',
          point: [100, 530, 550, 710],
          resourceId: 'bigVinylHouse',
        },
        {
          id: 'VNH_7',
          name: '하우스_7',
          point: [100, 730, 550, 810],
          resourceId: 'vinylHouse',
        },
        {
          id: 'VNH_8',
          name: '하우스_8',
          point: [100, 830, 550, 910],
          resourceId: 'vinylHouse',
        },
        {
          id: 'PCH',
          name: '펌프 제어반',
          point: [583.3333333333334, 730, 713.3333333333334, 910],
          resourceId: 'pumpPanel',
        },
        {
          id: 'PVA_1',
          name: 'PV_1_S_일반(7)_1',
          point: [100, 70, 493.75, 110],
          resourceId: 'pvN_7EA',
        },
        {
          id: 'PVA_2',
          name: 'PV_2_S_투명(7)_2',
          point: [100, 170, 493.75, 210],
          resourceId: 'pvT_7EA',
        },
        {
          id: 'PVA_3',
          name: 'PV_3_S_일반(7)_3',
          point: [100, 270, 493.75, 310],
          resourceId: 'pvN_7EA',
        },
        {
          id: 'PVA_4',
          name: 'PV_4_S_투명(7)_4',
          point: [100, 370, 493.75, 410],
          resourceId: 'pvT_7EA',
        },
        {
          id: 'PVA_5',
          name: 'PV_5_M_투명(6)_5',
          point: [100, 470, 437.5, 510],
          resourceId: 'pvT_6EA',
        },
        {
          id: 'PVA_6',
          name: 'PV_6_M_일반(8)_6',
          point: [100, 670, 550, 710],
          resourceId: 'pvN_8EA',
        },
        {
          id: 'PVA_7-A',
          name: 'PV_7-A_M_투명(4)_7-A',
          point: [100, 770, 325, 810],
          resourceId: 'pvT_4EA',
        },
        {
          id: 'PVA_7-B',
          name: 'PV_7-B_M_일반(4)_7-B',
          point: [325, 770, 550, 810],
          resourceId: 'pvN_4EA',
        },
        {
          id: 'PVA_8-A',
          name: 'PV_8-A_M_투명(4)_8-A',
          point: [100, 870, 325, 910],
          resourceId: 'pvT_4EA',
        },
        {
          id: 'PVA_8-B',
          name: 'PV_8-B_M_일반(4)_8-B',
          point: [325, 870, 550, 910],
          resourceId: 'pvN_4EA',
        },
        {
          id: 'PV_N_021',
          name: 'A_021',
          point: [140, 530, 240, 670],
          resourceId: 'pvSensor',
        },
        {
          id: 'PV_N_022',
          name: 'B_022',
          point: [225, 530, 425, 670],
          resourceId: 'bigPvSensor',
        },
        {
          id: 'PV_N_023',
          name: 'C_023',
          point: [410, 530, 510, 670],
          resourceId: 'pvSensor',
        },
        {
          id: 'OS_024',
          name: '외기 환경_024',
          point: [225, 930, 425, 1070],
          resourceId: 'outsideSensor',
        },
        {
          id: 'CMD',
          name: '제어 영역',
          point: [583.3333333333334, 30, 713.3333333333334, 430],
          resourceId: 'cmdArea',
        },
      ],
      svgNodeList: [
    ...
    repeatNodeList: [
      {
        ...
        repeatCategory: 'node',
        nodeList: [
          { target_code: '1', target_name: '투명(I)' },
          { target_code: '2', target_name: '일반(I)' },
          { target_code: '11', target_name: '투명 1(I)' },
          { target_code: '12', target_name: '투명 2(I)' },
          { target_code: '13', target_name: '일반 1(M.I)' },
          { target_code: '14', target_name: '일반 2(M.I)' },
          { target_code: '15', target_name: '일반 3(M.I)' },
          { target_code: '16', target_name: '투명 4(M.I)' },
        ],
      },
      {
        ...
        dataLoggerDeviceList: [
          {
            ...
            serial_number: { type: 'Buffer', data: [58] },
            dccId: 'DCC_001',
            dpcId: 'DPC_IVT_003',
            repeatId: 'RE_PREFIX_IVT',
          },
          {
            ...
            serial_number: { type: 'Buffer', data: [57] },
            dccId: 'DCC_001',
            dpcId: 'DPC_IVT_003',
            repeatId: 'RE_PREFIX_IVT',
          },
        ...
        defList: [
          {
            ...
            nodeList: [
              {
                target_code: '022',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.25, 0.15] },
              },
              {
                target_code: '024',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.25, 0.15] },
          ...
          },
          {
            ...
            nodeList: [
              {
                target_code: '022',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.75, 0.15] },
              },
              {
                target_code: '024',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.75, 0.15] },
        ...
        defList: [
          {
            ...
            nodeList: [
              {
                target_code: '022',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.25, 0.85] },
              },
              {
                target_code: '024',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.25, 0.85] },
          ...
          },
          {
            ...
            nodeList: [
              {
                target_code: '022',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.75, 0.85] },
              },
              {
                target_code: '024',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.75, 0.85] },
        ...
        defList: [
          {
            ...
            nodeList: [
              {
                target_code: '024',
                svgNodePosOpt: { resourceId: 'sensor', axisScale: [0.5, 0.5] },
              },
            ],
          },
          {
        ...
        defList: [
          {
            ...
            repeatId: 'RE_NODE_IVT',
            nodeList: [
              { target_code: '1', target_name: '투명 1(I)' },
              { target_code: '2', target_name: '일반 2(I)' },
            ],
          },
          {
            target_id: 'pvVol',
            ...
            nodeList: [
              {
                target_code: '1',
                target_name: '출력',
                svgNodePosOpt: { resourceId: 'powerGridKw', axisScale: [0.5, 0.8] },
              },
              {
                target_code: '2',
                target_name: '출력',
            ...
            placeList: [
              {
                ...
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 30] },
              },
              {
                target_code: '2',
                nodeList: ['ST_003', 'ST_004'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 130] },
              },
              {
                target_code: '3',
                nodeList: ['ST_005', 'ST_006'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 230] },
              },
              {
                target_code: '4',
                nodeList: ['ST_007', 'ST_008'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 330] },
              },
              {
                target_code: '5',
                nodeList: ['ST_009', 'ST_010'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 430] },
              },
              {
                target_code: '6',
                nodeList: ['ST_011', 'ST_012'],
                svgPositionInfo: { resourceId: 'bigVinylHouse', point: [100, 530] },
              },
              {
                target_code: '7',
                nodeList: ['ST_013', 'ST_014'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 730] },
              },
              {
                target_code: '8',
                nodeList: ['ST_015', 'ST_016', 'ST_CT'],
                svgPositionInfo: { resourceId: 'vinylHouse', point: [100, 830] },
              },
            ],
          },
          {
            ...
            placeList: [
              {
                ...
                svgPositionInfo: { resourceId: 'pvN_7EA', point: [100, 70] },
              },
              {
                target_code: '2',
                target_name: 'PV_2_S_투명(7)',
                svgPositionInfo: { resourceId: 'pvT_7EA', point: [100, 170] },
              },
              {
                target_code: '3',
                target_name: 'PV_3_S_일반(7)',
                nodeList: ['IVT_PW_G_KW_1'],
                svgPositionInfo: { resourceId: 'pvN_7EA', point: [100, 270] },
              },
              {
                target_code: '4',
                target_name: 'PV_4_S_투명(7)',
                nodeList: ['IVT_PW_G_KW_2'],
                svgPositionInfo: { resourceId: 'pvT_7EA', point: [100, 370] },
              },
              {
                target_code: '5',
                target_name: 'PV_5_M_투명(6)',
                nodeList: ['IVT_PW_G_KW_11'],
                svgPositionInfo: { resourceId: 'pvT_6EA', point: [100, 470] },
              },
              {
                target_code: '6',
                target_name: 'PV_6_M_일반(8)',
                nodeList: ['IVT_PW_G_KW_12'],
                svgPositionInfo: { resourceId: 'pvN_8EA', point: [100, 670] },
              },
              {
                target_code: '7-A',
                target_name: 'PV_7-A_M_투명(4)',
                nodeList: ['IVT_PW_G_KW_13'],
                svgPositionInfo: { resourceId: 'pvT_4EA', point: [100, 770] },
              },
              {
                target_code: '7-B',
                target_name: 'PV_7-B_M_일반(4)',
                nodeList: ['IVT_PW_G_KW_14'],
                svgPositionInfo: { resourceId: 'pvN_4EA', point: [325, 770] },
              },
              {
                target_code: '8-A',
                target_name: 'PV_8-A_M_투명(4)',
                nodeList: ['IVT_PW_G_KW_15'],
                svgPositionInfo: { resourceId: 'pvT_4EA', point: [100, 870] },
              },
              {
                target_code: '8-B',
                target_name: 'PV_8-B_M_일반(4)',
                nodeList: ['IVT_PW_G_KW_16'],
                svgPositionInfo: { resourceId: 'pvN_4EA', point: [325, 870] },
              },
            ],
          },
        ],
            ...
            placeList: [
              {
                ...
                chart_sort_rank: 21,
                nodeList: ['S_PU_021'],
                svgPositionInfo: { resourceId: 'pvSensor', point: [140, 530] },
              },
              {
                target_code: '022',
                target_name: 'B',
                ...
                chart_sort_rank: 22,
                nodeList: ['S_PU_022', 'T_S_022', 'RH_S_022', 'T_OA_022', 'RH_OA_022'],
                svgPositionInfo: { resourceId: 'bigPvSensor', point: [225, 530] },
              },
              {
                target_code: '023',
                target_name: 'C',
                ...
                chart_sort_rank: 23,
                nodeList: ['S_PU_023'],
                svgPositionInfo: { resourceId: 'pvSensor', point: [410, 530] },
              },
            ],
          },
        ],
            ...
            placeList: [
              {
                ...
                chart_sort_rank: 24,
                nodeList: ['S_H_024', 'T_S_024', 'RH_S_024', 'T_OA_024', 'RH_OA_024'],
                svgPositionInfo: { resourceId: 'outsideSensor', point: [225, 930] },
              },
            ],
          },
        ],
    ...
    singleCmdList: [
      ...
      },
      {
        ...
        singleMidCateCmdInfo: {
          scenarioMsg: '제어 동작을 선택하세요.',
          subCmdList: [
            { enName: 'Unfold', krName: '접음', controlValue: 0 },
            { enName: 'Fold', krName: '펼침', controlValue: 1 },
          ],
        },
      },
    ],
    setCmdList: [
      {
        ...
        falseNodeList: [],
        svgNodePosOpt: { placeId: 'CMD', resourceId: 'cmdBtn', axisScale: [0.5, 0.1] },
      },
      {
        ...
        falseNodeList: [],
        svgNodePosOpt: { placeId: 'CMD', resourceId: 'cmdBtn', axisScale: [0.5, 0.3] },
      },
      {
      ...
      },
      {
        ...
        svgNodePosOpt: { placeId: 'CMD', resourceId: 'cmdBtn', axisScale: [0.5, 0.5] },
      },
      {
        ...
        svgNodePosOpt: { placeId: 'CMD', resourceId: 'cmdBtn', axisScale: [0.5, 0.7] },
      },
    ],
    flowCmdList: [],
  },
