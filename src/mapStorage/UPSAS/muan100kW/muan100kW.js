...
const map = {
      ...
      svgPlaceList: [
        {
          ...
          defList: [
            ...
            { id: 'NCB', name: '결정지', resourceId: 'normalCrystalizingBlock', point: [80, 3545] },
          ],
        },
        {
        ...
        },
        {
          placeId: 'waterWay',
          defList: [
            { id: 'WW_001', name: '수로_001', resourceId: 'waterWay', point: [10, 520, 2850, 520] },
            { id: 'WW_002', name: '수로_002', resourceId: 'waterWay', point: [40, 530, 40, 4360] },
            {
              id: 'WW_003',
              name: '수로_003',
              resourceId: 'waterWay',
        ...
        defList: [
          {
            ...
            nodeList: [
              ...
              { target_code: '002', data_logger_index: 1 },
            ],
          },
        ],
      },
  ...
  relationInfo: {
        ...
        defList: [
          {
            ...
            target_prefix: 'SEA',
            target_name: '바다',
            placeList: [{ target_code: '', depth: -1, nodeList: ['P_001'], place_info: {} }],
          },
        ],
      },
      {
        ...
        defList: [
          {
            ...
            target_prefix: 'JG',
            target_name: '자고',
            placeList: [{ target_code: '', depth: -1, nodeList: ['P_002'], place_info: {} }],
          },
        ],
      },
      {
        ...
        defList: [
          {
            ...
            placeList: [
              ...
              { target_code: '008', nodeList: ['WD_005'], depth: 0.4 },
              { target_code: '009', nodeList: ['WD_003'], depth: 0.5 },
              { target_code: '010', nodeList: ['WD_006'], depth: 0.3 },
              { target_code: '011', nodeList: ['WD_005'], depth: 0.4 },
              { target_code: '012', nodeList: ['WD_004'], depth: 0.5 },
              { target_code: '013', nodeList: ['WD_007'], depth: 0.3 },
              { target_code: '014', nodeList: ['WD_008'], depth: 0.8 },
              { target_code: '015', nodeList: ['WD_009'], depth: 0.8 },
              { target_code: '016', nodeList: ['WD_010'], depth: 0.7 },
    ...
    svgResourceConnectionList: [
      ...
      { targetIdList: ['JG'], resourceIdList: ['jago'] },
      ...
      { targetIdList: ['P_001', 'P_002', 'P_003', 'P_004'], resourceIdList: ['overPump'] },
      {
        targetIdList: [
          'GV_101',
          'GV_102',
  ...
  controlInfo: {
    flowCmdList: [
      {
        srcPlaceId: 'SEA',
        destList: [{ destPlaceId: 'RV', trueNodeList: ['P_001'], falseNodeList: [] }],
      },
      {
        srcPlaceId: 'RV',
        destList: [
          { destPlaceId: 'NEB_1', trueNodeList: ['P_003'], falseNodeList: ['WD_001', 'WD_002'] },
        ],
      },
      {
        srcPlaceId: 'NEB_1',
      ...
      {
        srcPlaceId: 'BW_4',
        destList: [{ destPlaceId: 'BW_5', trueNodeList: ['P_013'], falseNodeList: [] }],
      },
      {
        srcPlaceId: 'BW_5',
        destList: [{ destPlaceId: 'NCB', trueNodeList: ['P_014'], falseNodeList: ['WD_008'] }],
      },
      {
        srcPlaceId: 'JG',
