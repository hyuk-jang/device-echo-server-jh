...
var map = {
  ...
  relationInfo: {
        ...
        defList: [
          {
            ...
            placeList: [
              { target_code: '1', nodeList: [], depth: 5, place_info: {} },
              { target_code: '2', nodeList: [], depth: 5, place_info: {} },
              { target_code: '3', nodeList: [], depth: 5, place_info: {} },
              { target_code: '4', nodeList: [], depth: 5, place_info: {} },
              { target_code: '5', nodeList: [], depth: 5, place_info: {} },
              { target_code: '6', nodeList: [], depth: 5, place_info: {} },
              { target_code: '7', nodeList: [], depth: 5, place_info: {} },
              { target_code: '8', nodeList: [], depth: 5, place_info: {} },
            ],
          },
          {
            ...
            target_name: '일반 증발지',
            placeList: [
              { target_code: '1', nodeList: ['WD_001'], depth: 5, place_info: {} },
              { target_code: '2', nodeList: [], depth: 4, place_info: {} },
            ],
          },
          {
            ...
            target_prefix: 'NCB',
            target_name: '일반 결정지',
            placeList: [{ target_code: '', nodeList: [], depth: 0, place_info: {} }],
          },
        ],
      },
      {
        ...
        defList: [
          {
            ...
            target_name: '해주',
            placeList: [
              { target_code: '1', nodeList: [], depth: -1, place_info: {} },
              { target_code: '2', nodeList: ['P_004'], depth: -1, place_info: {} },
              { target_code: '3', nodeList: [], depth: -1, place_info: {} },
              { target_code: '4', nodeList: [], depth: -1, place_info: {} },
              { target_code: '5', nodeList: [], depth: -1, place_info: {} },
              { target_code: '6', nodeList: [], depth: -1, place_info: {} },
            ],
          },
        ],
      },
        ...
        defList: [
          {
            ...
            placeList: [
              { target_code: '1', nodeList: [], depth: -1, place_info: {} },
              { target_code: '2', nodeList: [], depth: -1, place_info: {} },
            ],
          },
        ],
      },
    ...
    svgResourceConnectionList: [
      ...
      { targetIdList: ['P_004'], resourceIdList: ['underPump'] },
      { targetIdList: ['GV_106'], resourceIdList: ['gateValve'] },
      { targetIdList: ['WD_001'], resourceIdList: ['waterDoor'] },
      {
        targetIdList: [
          'O_001',
          'O_002',
  ...
  controlInfo: {
    flowCmdList: [
      {
        srcPlaceId: 'RV_1',
        destList: [{ destPlaceId: 'NEB_1', trueNodeList: [], falseNodeList: ['WD_001'] }],
      },
      {
        srcPlaceId: 'RV_2',
      ...
      },
      {
        srcPlaceId: 'NEB_1',
        destList: [
          { destPlaceId: 'NEB_2', trueNodeList: [], falseNodeList: ['WD_001'] },
      ...
      },
      {
        srcPlaceId: 'SEB_1',
        destList: [
          { destPlaceId: 'BW_2', trueNodeList: [], falseNodeList: ['GV_106'] },
          { destPlaceId: 'BW_3', trueNodeList: [], falseNodeList: ['GV_106'] },
      ...
      },
      {
        ...
        destList: [
          { destPlaceId: 'BW_2', trueNodeList: [], falseNodeList: [] },
          { destPlaceId: 'BW_3', trueNodeList: [], falseNodeList: [] },
          { destPlaceId: 'SEA', trueNodeList: [], falseNodeList: [] },
        ],
      },
      {
      ...
      },
      {
        ...
        destList: [
          { destPlaceId: 'BW_3', trueNodeList: [], falseNodeList: [] },
          { destPlaceId: 'BW_4', trueNodeList: [], falseNodeList: [] },
          { destPlaceId: 'SEA', trueNodeList: [], falseNodeList: [] },
        ],
      },
      {
      ...
      {
        srcPlaceId: 'BW_1',
        destList: [{ destPlaceId: 'NEB_2', trueNodeList: [], falseNodeList: [] }],
      },
      {
        srcPlaceId: 'BW_2',
        destList: [
    ...
    setCmdList: [
      { cmdId: 'closeAllDevice', trueNodeList: [], falseNodeList: ['GV_106', 'WD_001', 'P_004'] },
      { cmdId: 'rainMode', trueNodeList: ['GV_106', 'WD_001'], falseNodeList: ['P_004'] },
    ],
    scenarioCmdList: [
      {
        scenarioId: 'rainMode',
